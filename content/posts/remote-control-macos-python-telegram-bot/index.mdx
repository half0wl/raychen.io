...
slug: "/writing/remote-controlling-macos-with-telegram-bot"
date: 2017-09-20
tags:
  - "python"
  - "automation"
...
*(This is a mirror of my [post on Medium](https://medium.com/a-chatbots-life/remote-controlling-macos-with-a-python-telegram-bot-d656d2e00226), originally published on 20 Sep 2017. The content is still relevant, but libraries and APIs may have changed since. I also suck at writing 5 years ago so this may not read well; I'm leaving this up for my own posterity.)*

![Screenshot of chatbot in action](./demo.png)
